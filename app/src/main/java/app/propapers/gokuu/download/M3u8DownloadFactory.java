package app.propapers.gokuu.download;

import app.propapers.gokuu.Exception.M3u8Exception;
import app.propapers.gokuu.listener.DownloadListener;
import app.propapers.gokuu.utils.Constant;
import app.propapers.gokuu.utils.Log;
import app.propapers.gokuu.utils.MediaFormat;
import app.propapers.gokuu.utils.StringUtils;
...
import static app.propapers.gokuu.utils.Constant.FILESEPARATOR;
            ...
            return new Thread(() -> {
                ...
                while (count <= retryCount) {
                    try {
                        ...
                        httpURLConnection.setRequestProperty("Referrer","https://www.google.com/");
